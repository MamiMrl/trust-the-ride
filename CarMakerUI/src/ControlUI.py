...
class TeslaStyleApp(ctk.CTk):
    def __init__(self):
        ...
        self.title('CarMaker Control UI')
    ...
    def init_carmaker(self):
        # Change IP_ADDRESS to the Host IP Address that CarMaker Software is running on
        IP_ADDRESS = "localhost"
        PORT = 16660
        self.cm = CarMaker(IP_ADDRESS, PORT)
        self.cm.connect()
        self.qacceleration = Quantity("Driver.ReCon.DriveChar.CF_GGExp", Quantity.FLOAT)
